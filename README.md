...
1. Explain what a token is used for.
      --In this context, authentication.
2. What steps can you take in your web apps to keep your data secure?
      --Keep it on the backend, and have endpoints that require authentication. For example a proper jwt token
3. Describe how web servers work.
      --Essentially, they listen on port 80 (although 443 for https), and respond to HTTP requests. There's a lot of complexity behind the scenes, but thats the basics.
